    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        .requestMatchers("/api/auth/**","/api/offre/**","/api/entreprise/**","/api/candidat/**","/socket.io/**", "/ws/**","/api/formation/**","/api/experience/**","/api/candidature/**","/api/competences/**","/api/langues/**","/api/abouts/**").permitAll() // Autoriser l'accès public/anonyme
